      ...
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="grid gap-4 mb-8">
            <FeatureItem
              icon={<Activity className={tokens.icons.md} />}
              title="Detailed Analytics"
              description="Track pace, distance, SWOLF, and more"
            />
            <FeatureItem
              icon={<TrendingUp className={tokens.icons.md} />}
              title="Progress Insights"
              description="See how you're improving over time"
            />
            <FeatureItem
              icon={<Trophy className={tokens.icons.md} />}
        ...
        >
          ...
          >
            {isSigningIn ? (
              <>
                <div className={`${tokens.icons.md} border-2 border-gray-400 border-t-gray-900 rounded-full animate-spin`} />
                Signing in...
              </>
            ) : (
              <>
                <svg className={tokens.icons.md} viewBox="0 0 24 24">
                  <path
                    fill="#4285F4"
          ...
          {error && (
            <div className={`${tokens.margin.group} ${tokens.padding.default} bg-red-500/10 border border-red-500/20 ${tokens.radius.lg} text-red-400 ${tokens.typography.sizes.sm}`}>
              {error}
            </div>
          )}
