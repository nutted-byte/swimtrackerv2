// Technique article content (separated to optimize token usage)
// This file contains the full markdown content for each article

export const techniqueArticlesContent = {
  'understanding-swolf': `
